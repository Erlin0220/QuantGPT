    ...
    async with factory() as session:
        ...
        for candidate in candidates:
            ...
            values = {
                ...
                "failure_signature": dict(meta.get("failure_signature") or candidate.get("failure_signature") or {}),
                "diversity_case": dict(meta.get("diversity_case") or candidate.get("diversity_case") or {}),
    ...
    async with factory() as session:
        ...
        def candidate_payload(item: WQResearchCandidate) -> dict[str, Any]:
            ...
            return {
                ...
                "failure_signature": item.failure_signature or {},
                "diversity_case": item.diversity_case or {},
