...
def _inventory_view(policy: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "high_confidence_count": inventory.get("high_confidence_count", policy.get("high_confidence_candidate_count")),
        "deficit": inventory.get("deficit", policy.get("inventory_deficit")),
...
def build_research_control_tower(
    ...
    *,
    ...
    return {
        ...
        "metadata": {"completeness": memory.get("metadata_completeness") or {}},
        "scheduler": {
            "inventory_mode": inventory["mode"],
