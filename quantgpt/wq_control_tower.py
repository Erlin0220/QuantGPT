    ...
    *,
    ...
    return {
        ...
        "safeguards": {
            ...
            "local_correlation_is_predictive_only": False,
            "fresh_high_local_correlation_blocks_submission": True,
            "weak_available_overfitting_evidence_blocks_submission": True,
