...
class WQResearchCandidate(Base):
    ...
    provenance_state = Column(String(20), nullable=True)
    provenance_reason = Column(String(200), nullable=True)
    ...
    local_correlation = Column(Float, nullable=True)
    local_correlation_alpha_id = Column(String(50), nullable=True)
    local_correlation_samples = Column(Integer, nullable=True)
    local_correlation_at = Column(DateTime(timezone=True), nullable=True)
    validation_details = Column(JSON, nullable=True)
    tag = Column(String(100), nullable=True)
    lineage_id = Column(String(40), nullable=True, index=True)
    parent_lineage_id = Column(String(40), nullable=True, index=True)
    operator_pattern = Column(Text, nullable=True)
    operators = Column(JSON, nullable=True)
    mutation_reason = Column(Text, nullable=True)
    planner_strategy = Column(String(100), nullable=True)
    allocation_cell = Column(String(200), nullable=True)
...
class WQResearchTrial(Base):
    ...
    failure_stage = Column(String(30), nullable=True, index=True)
    failure_reason = Column(String(60), nullable=True, index=True)
    failure_reasons = Column(JSON, nullable=True)
    failure_evidence = Column(JSON, nullable=True)
